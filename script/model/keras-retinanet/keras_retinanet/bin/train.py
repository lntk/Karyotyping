...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.snapshots:
        ...
        checkpoint = keras.callbacks.ModelCheckpoint(
            os.path.join(
                args.snapshot_path,
                '{backbone}_{dataset_type}_{day}.h5'.format(backbone=args.backbone, dataset_type=args.dataset_type,
                                                            day=args.day)
            ),
            verbose=1,
            save_best_only=True,
...
def parse_args(args):
    ...
    # khang
    parser.add_argument('--day', help='Day of experiment', default='test')
